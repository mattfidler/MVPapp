...
From v0.4.0, users now have the option to Save and Load Sessions (located on the Main Simulation page, below the code editor), which may be more convenient. The original password-unlocked models functionality detailed below still remains supported, as it can handle multiple models.
